...
def terms():
    data = [
        ...
        },
        {
            ...
            "description_ro": "seitekipe-jitoha,itudemodokodeakusesusitemomaikaionajimonogahyoujisareru,HTMLfairudesakuseisaretawebpe-jinokotodesu.yu-za-noyoukyuunitaisite,websa-ba-gayoukyuusaretade-tawosonomamaburauzanisousinnsi,hyoujisimasu.seitekipe-jiha,sonowebpe-jinoseisakusyagasousinwosinaikagirinaiyouhaissaihenkasimasenn.seitekipe-jihakigyounosyoukaisaitonado,yu-za-nonyuuryokunaiyouyakankyouniyottehyoujinisagadetesimautokomarunaiyouwokeisaisurunonitekisiteimasu."
        },
        {
            "terminologie_id": 3,
            "genre_id": 1,
        ...
        },
        {
            ...
            "description_ro": "nginxhaseitekikontentu(tumarisa-bajounofairu)wokousokunihaisinsuruyounisekkeisareteiru.mata,riba-supurokisinokinouwomotutame,haigoniWebapurike-syonsa-bawohaitisitedoutekinakontentuwohaisinsitari,sohutowearo-dobaransayaHTTP kyassyutositetukaukotomodekiru.kakusyunowebuapurike-syonyouinta-fe-sumohyoujundesapo-tositeiru."
        },
        {
            "terminologie_id": 5,
            "genre_id": 2,
        ...
        },
        {
            ...
            "description_ja": "OSI[Open Systems Interconnection]参照モデルとは、国際標準化機構[ISO]により策定されたコンピュータなどの通信機器の通信機能を、階層構造に分割したモデルです。このOSI参照モデルでは通信プロトコルを7つの階層に分けて、それぞれの階層で行われる通信機能を定義しています。また、OSI参照モデルにより、ネットワーク全体でどのようにデータが伝送されていくのか、ネットワークの仕組みを分かりやすく理解できるように促進している側面もあります。ネットワークエンジニアが設計、構築、障害対応などでプロトコルに関して議論する場合は、OSI参照モデルに基づき話をすることが一般的です。",
            "description_ro": "OSI[Open System Interconnection]sansyoumoderutoha,kokusaihyoujunkakikou[ISO]niyotisakuteisaretakonpyu-tanadonotuusinkikinotusinkinouwo,kaisoukouzounibunkatusitamoderudesu.konoOSIsansyoumoderudehatuusinpurotokoruwo7tunokaisouniwakete,sorezorenokaisoudeokonawarerutuusinkinouwoteigisiteimasu.mata,OSIsansyoumoderuniyori,nettowa-kuzentaidedonoyounide-tagadensousareteikunoka,nettowa-kunosikummiwowakariyasukurikaidekiruyounisokusinsiteirusokumenmoarimasu.nettowa-kuenjiniagasekkei,koutiku,syougaitaiounadodepurotokorunikansitegironsruubaaiha,OSIsansyoumoderunimotodukihanasiwosurukotogaippantekidesu."
        },
        {
            "terminologie_id": 10,
            "genre_id": 3,
            ...
            "description_ro": "DNStoha,inta-nettonadonoIPnettowa-kujoudedomeinmei[hosutomei]toIPadoresudehanaku,nitijoutukatteirugengonomojiwokumiawasetaninsikisiyasuidomeinmeidenettowa-kujounosigennniakusesudekiruyounisuru."
        },
    ]
